...
const RightSideContainer = () => {
  ...
  return (
    selectedUser && (
      <div
        className={`bg-[#8185B2]/10 text-white w-full h-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}
      >
...
{msgImage.map((url, index) => (
              ...
              >
                <img src={url} alt="" className="h-full rounded-md w-full object-cover" />
              </div>
            ))}
